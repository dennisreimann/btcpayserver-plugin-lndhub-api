...
:::tip NOTE
The prerequisite for a Lightning wallet to be accessible like this is having an API key with the manage store Lightning node permission tight to it.
The API key can be managed via your user settings.
:::
